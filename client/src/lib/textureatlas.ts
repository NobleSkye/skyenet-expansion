...
export class TextureAtlas {
    ...
    constructor(imagePath: string, atlasData: Record<string, TextureRegion>, tileSize: number = 32) {
    ...
    public static createGridAtlas(imagePath: string, tileSize: number = 32): TextureAtlas {
